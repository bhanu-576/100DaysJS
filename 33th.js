...
? Your Challenge is to implement the randomHexColor function using js and ensure that it produces a 
?valid hexadecimal color code with a length of 7 characters (including the # symbol).
